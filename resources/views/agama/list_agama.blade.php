            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route("agama.create") }}" type="button" class="float-end btn btn-success btn-rounded waves-effect waves-light mb-2 me-2">
                                ...
                                @foreach ($lists as $list)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form class="delete-form" action="{{ route('agama.destroy', ['id' => $id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
