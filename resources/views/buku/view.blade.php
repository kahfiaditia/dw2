                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="judul" name="judul"
                                                autofocus value="{{ $buku->judul }}" disabled placeholder="Judul">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="pengarang" name="pengarang"
                                                value="{{ $buku->pengarang }}" disabled placeholder="Pengarang">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="validationCustom02" class="form-label">Penerbit</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="thn_terbitan"
                                                style="padding: 7px;" maxlength="4" placeholder="Tahun Terbitan" disabled
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group" id="datepicker2">
                                                <input type="text" class="form-control" placeholder="yyyy-mm-dd"
                                                    name="tgl_masuk" value="{{ $buku->tgl_masuk }}" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Foto Buku (Max 2 Mb)</label>
                                            <br>
                                            @if ($buku->foto)
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="validationCustom02" class="form-label">Jumlah Buku</label>
                                            <input data-parsley-type="number" type="text"
                                                class="form-control number-only" id="jml_buku" name="jml_buku"
                                                value="{{ $buku->jml_buku }}" disabled placeholder="Jumlah Buku">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
