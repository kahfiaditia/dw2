                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="validationCustom02" class="form-label">Roles</label>
                                                    <input type="text" class="form-control" value="{{ Auth::user()->roles }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="validationCustom02" name="rt_asal" value="{{ old('rt_asal') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="validationCustom02" name="rw_asal" value="{{ old('rw_asal') }}"
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="validationCustom02" class="form-label">RT <code>*</code></label>
                                                            <input type="number" class="form-control alamat-sama" id="validationCustom02" name="rt" value="{{ old('rt') }}"
                                                                placeholder="RT" required>
                                                            <div class="invalid-feedback">
                                                                Data wajib diisi.
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="validationCustom02" class="form-label">RW <code>*</code></label>
                                                            <input type="number" class="form-control alamat-sama" id="validationCustom02" name="rw" value="{{ old('rw') }}"
                                                                placeholder="RW" required>
                                                            <div class="invalid-feedback">
                                                                Data wajib diisi.
                                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <div class="input-group" id="datepicker2">
                                                        <input type="text" class="form-control" placeholder="yyyy-mm-dd" name="masuk_kerja" value="{{ old('masuk_kerja') }}"
                                                            data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" required
                                                            data-date-autoclose="true" >
                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                        <div class="invalid-feedback">
    ...
    $(document).ready(function(){
        ...
        $(".ProvinsiA").change(function(){
            ...
            $.ajax({
                ...
                data: {
                    "_token": "{{ csrf_token() }}",Provinsi
                },
                success: response => {
                    $('.KotaA').append(`<option value="">-- Pilih Kota --</option>`)
                    $.each(response, function(i, item) {
                        $('.KotaA').append(`<option value="${item.kabupaten}">${item.kabupaten}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KotaA").change(function(){
            ...
            $.ajax({
                ...
                data: {
                    "_token": "{{ csrf_token() }}",Provinsi,Kota
                },
                success: response => {
                    $('.KecamatanA').append(`<option value="">-- Pilih Kecamatan --</option>`)
                    $.each(response, function(i, item) {
                        $('.KecamatanA').append(`<option value="${item.kecamatan}">${item.kecamatan}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KecamatanA").change(function(){
            ...
            $.ajax({
                ...
                data: {
                    "_token": "{{ csrf_token() }}",Provinsi,Kota,Kecamatan
                },
                success: response => {
                    $('.KelurahanA').append(`<option value="">-- Pilih Kelurahan --</option>`)
                    $.each(response, function(i, item) {
                        $('.KelurahanA').append(`<option value="${item.kelurahan}">${item.kelurahan}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KelurahanA").change(function(){
            ...
            $.ajax({
                ...
                data: {
                    "_token": "{{ csrf_token() }}",Provinsi,Kota,Kecamatan,Kelurahan
                },
                success: response => {
                    $('.KodeposA').append(`<option value="">-- Pilih Kodepos --</option>`)
                    $.each(response, function(i, item) {
                        $('.KodeposA').append(`<option value="${item.kodepos}">${item.kodepos}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".ProvinsiT").change(function(){
            ...
            $.ajax({
                ...
                success: response => {
                    ...
                    $.each(response, function(i, item) {
                        $('.KotaT').append(`<option value="${item.kabupaten}">${item.kabupaten}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KotaT").change(function(){
            ...
            $.ajax({
                ...
                success: response => {
                    $('.KecamatanT').append(`<option value="">-- Pilih Kecamatan --</option>`)
                    $.each(response, function(i, item) {
                        $('.KecamatanT').append(`<option value="${item.kecamatan}">${item.kecamatan}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KecamatanT").change(function(){
            ...
            $.ajax({
                ...
                success: response => {
                    $('.KelurahanT').append(`<option value="">-- Pilih Kelurahan --</option>`)
                    $.each(response, function(i, item) {
                        $('.KelurahanT').append(`<option value="${item.kelurahan}">${item.kelurahan}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
        ...
        $(".KelurahanT").change(function(){
            ...
            $.ajax({
                ...
                success: response => {
                    ...
                    $.each(response, function(i, item) {
                        $('.KodeposT').append(`<option value="${item.kodepos}">${item.kodepos}</option>`)
                    })
                },
                error: (err) => {
                    console.log(err);
