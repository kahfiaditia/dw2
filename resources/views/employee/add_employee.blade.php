                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="{{old('nama_lengkap')}}"  autofocus
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-check-label" style="float:right" for="container">Alamat sama dengan Ayah</label>
