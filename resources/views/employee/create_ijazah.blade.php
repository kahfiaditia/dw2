                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_pendidikan"
                                                            name="nama_pendidikan" value="{{ old('nama_pendidikan') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-daterange input-group">
                                                            <input type="text" class="form-control datepicker"
                                                                name="tahun_masuk" maxlength="4" placeholder="Tahun Masuk"
                                                                id="tahun_masuk" required>
                                                            <input type="text" class="form-control datepicker"
                                                                name="tahun_lulus" maxlength="4" placeholder="Tahun Lulus"
