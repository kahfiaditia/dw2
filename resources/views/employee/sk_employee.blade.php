                                ...
                                <div class="card shadow-none border mb-0">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <form class="needs-validation" action="{{ route('employee.store_sk') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            <label for="validationCustom02" class="form-label">No SK
                                                                <code>*</code></label>
                                                            <input type="text" class="form-control" id="no_sk"
                                                                name="no_sk" value="{{ old('no_sk') }}" required
                                                                placeholder="No SK">
                                            ...
                                            <div class="col-12">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <form class="delete-form"
                                                                        action="{{ route('employee.destroy_sk', ['id' => $id]) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-sm-12">
                                                        <?php $id = Crypt::encryptString($item->id); ?>
                                                        <a href="{{ url('employee/ijazah', $id) }}"
                                                            class="btn btn-secondary waves-effect">Kembali</a>
                                                        <a href="{{ url('employee/child', $id) }}" style="float: right"
