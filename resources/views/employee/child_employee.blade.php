                                                ...
                                                <div class="accordion" id="accordionExample">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input type="number" min="0" maxlength="2" class="form-control" id="anak_ke" name="anak_ke" value="{{ old('anak_ke') }}" required
                                                                                        placeholder="Anak Ke">
                                                                                ...
                                                                                @foreach ($child as $list)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <form class="delete-form" action="{{ route('employee.destroy_anak', ['id' => $id]) }}" method="POST">
                                                                                                @csrf
                                                                                                @method('DELETE')
                                                                                                <div class="d-flex gap-3">
                                                                                                    <a href="javascript:void(0)" data-id="{{ $id.'|anak|'.$list->karyawan_id }}" class="text-success" id="get_data_edit" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg-edit">
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                            <div class="accordion-body">
                                                                <div class="text-muted">
                                                                    <form class="needs-validation" action="{{ route("employee.store_child_dw") }}" method="POST" novalidate>
                                                                        @csrf
                                                                        <?php $id = Crypt::encryptString($item->id); ?>
                                                                        <input type="hidden" name="karyawan_id" value="{{ $id }}">
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <select class="form-control select select2" name="anak_karyawan" id="anak_karyawan" >
                                                                            ...
                                                                            @if (count($school) >= 3)
                                                                                <div class="col-md-12">
                                                                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                                                        <i class="mdi mdi-block-helper me-2"></i>
                                                                                        Anak Karyawan Sekolah di Dharmawidya maksimal 3
                                                                                    </div>
                                                                                </div>
                                                                            @endif
                                                                        </div>
                                                                            ...
                                                                            <tbody>
                                                                                @foreach ($school as $list)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <?php $id = Crypt::encryptString($list->id); ?>
                                                                                            <form class="delete-form" action="{{ route('employee.destroy_dw', ['id' => $id]) }}" method="POST">
                                                                                                @csrf
                                                                                                @method('DELETE')
                                                                                                <div class="d-flex gap-3">
                                                                                                    <a href="javascript:void(0)" data-id="{{ $id.'|dw|'.$list->karyawan_id }}" class="text-success" id="get_data_edit" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg-edit">
                                                                                                        <i class="mdi mdi-pencil font-size-18"></i>
                                                                                                    </a>
                                                                                                    <a href class="text-danger delete_confirm"><i class="mdi mdi-delete font-size-18"></i></a>
                                                                                                </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="text-sm-end mt-2 mt-sm-0">
                                                    <a href="{{ url('employee/riwayat',$id) }}" class="btn btn-primary">Next</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
