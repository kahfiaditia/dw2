...
<form action="{{ route('employee.destroy', \Crypt::encryptString($model->id)) }}" method="POST">
    @csrf
    @method('DELETE')
    <div class="d-flex gap-3">
        ...
        @if (in_array('4', $session_menu))
            <a href="{{ route('employee.edit', \Crypt::encryptString($model->id)) }}" class="text-success"><i
