    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control" id="edit_anak_ke" name="edit_anak_ke"
                    value="{{ $item->anak_ke }}" autofocus placeholder="Anak Ke">
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                <label for="validationCustom02" class="form-label">Nama <code>*</code></label>
                <input type="text" class="form-control" id="edit_nama" name="edit_nama" value="{{ $item->nama }}"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control" id="edit_usia" name="edit_usia"
                    value="{{ $item->usia }}" autofocus placeholder="Usia">
            </div>
        </div>
    </div>
