...
@section('container')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('obat.update', Crypt::encryptString($data->id)) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="obat" name="obat"
                                                ...
                                                onkeyup="this.value = this.value.toUpperCase();" value="{{ $data->obat }}"
                                            ...
                                            <select class="form-control select select2" name="jenis" required>
                                                ...
                                                @foreach ($jenis_obat as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $item->id == $data->id_jenis_obat ? 'selected' : '' }}>
