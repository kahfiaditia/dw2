...
@section('container')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('bills.store') }}" method="POST" novalidate>
                @csrf
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="bills" placeholder="Tagihan"
                                            autofocus required value="{{ old('bills') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="validationCustom02" class="form-label">Keterangan
                                                <code>*</code></label>
                                            <div>
                                                <textarea required class="form-control" name="notes" placeholder="Keterangan" rows="3">{{ old('notes') }}</textarea>
                                                <div class="invalid-feedback">
                                                    Data wajib diisi.
                                                </div>
                                            </div>
