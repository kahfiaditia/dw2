...
@section('container')
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 wajib">
                                            <div class="mb-3">
                                                <label>Kondisi Barang Kembali <code>*</code></label>
                                                <div class="input-group">
                                                    <input type="disable" class="form-control"
                                                        value="{{ $data_pinjaman[0]->barang_kembali }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                                                ...
                                                                <form class="delete-form"
                                                                    ...
                                                                    <div class="d-flex gap-3">
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            <i
                                                                                class="mdi mdi-orbit-variant font-size-22"></i>
                                                                        </a>
                                                                    </div>
                                                                    <?php } else if($item->tgl_kembali != NULL) { ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myExtraLargeModalLabel">Pengembalian</h5>
    ...
    <script>
        $(document).on('click', '#get_data_edit', function(e) {
            ...
            var url = "{{ route('inv_pinjaman.kembaliBarang') }}"
            $.ajax({
                    url: url,
                    type: 'POST',
                    data: {
