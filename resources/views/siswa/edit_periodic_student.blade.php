                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group">
                                                            <input type="text" class="number-only form-control"
                                                                ...
                                                                value="{{ old('tinggi_badan', $periodic->tinggi_badan) }}"
                                                                required>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group">
                                                            <input type="text" class="number-only form-control"
                                                                ...
                                                                value="{{ old('berat_badan', $periodic->berat_badan) }}"
                                                                required>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group">
                                                            <input type="text" class="number-only form-control"
                                                                ...
                                                                value="{{ old('lingkar_kepala', $periodic->lingkar_kepala) }}"
                                                                required>
                                                            <span class="input-group-text">Cm</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <select name="jarak_tempuh" class="form-control" required>
                                                        ...
                                                        <option value="Kurang dari 1 Km"
                                                            @if ($periodic->jarak_tempat_tinggal_ke_sekolah == 'Kurang dari 1 Km') selected @endif>
                                                            Kurang dari 1 Km</option>
                                                        <option value="Lebih dari 1 Km"
                                                            @if ($periodic->jarak_tempat_tinggal_ke_sekolah == 'Lebih dari 1 Km') selected @endif>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group">
                                                            <input type="text" class="number-only form-control"
                                                                ...
                                                                value="{{ old('in_km', $periodic->in_km) }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="number-only form-control"
                                                        ...
                                                        value="{{ old('saudara_kandung', $periodic->jumlah_saudara_kandung) }}">
                                                    <div class="invalid-feedback">
                                                        Data wajib diisi.
                                                    </div>
