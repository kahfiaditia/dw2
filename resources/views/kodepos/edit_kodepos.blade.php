                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="provinsi" name="provinsi"
                                                value="{{ $kodepos->provinsi }}" required placeholder="Provinsi"
                                                autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kabupaten" name="kabupaten"
                                                value="{{ $kodepos->kabupaten }}" required placeholder="Kota">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kelurahan" name="kelurahan"
                                                value="{{ $kodepos->kelurahan }}" required placeholder="Kelurahan">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kecamatan" name="kecamatan"
                                                value="{{ $kodepos->kecamatan }}" required placeholder="Kecamatan">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kodepos" name="kodepos"
                                                value="{{ $kodepos->kodepos }}" required placeholder="Kodepos">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                        </div>
