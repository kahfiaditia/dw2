...
@section('container')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('diskon.update', Crypt::encryptString($diskon->id)) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="">Type Diskon Pembayaran <code>*</code></label><select
                                                ...
                                                <option value="1" {{ $diskon->type_diskon == 1 ? 'selected' : '' }}>
                                                    Pembayaran</option>
                                                <option value="0" {{ $diskon->type_diskon == 0 ? 'selected' : '' }}>
                                                    Prestasi
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="diskon"
                                                placeholder="Nama Diskon" required value="{{ $diskon->diskon }}">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                            @error('diskon')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="keterangan"
                                                placeholder="Keterangan Diskon" required value="{{ $diskon->keterangan }}">
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
                                            @error('keterangan')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="diskon_bln" maxlength="2"
                                                ...
                                                placeholder="Jumlah Diskon Bulan" value="{{ $diskon->diskon_bln }}">
                                            <div class="invalid-feedback">
