                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="provinsi" name="provinsi" value="{{old('provinsi')}}" required placeholder="Provinsi" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kabupaten" name="kabupaten" value="{{old('kabupaten')}}" required placeholder="Kota">
                                        <div class="invalid-feedback">
                                            Data wajib diisi.
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kelurahan" name="kelurahan" value="{{old('kelurahan')}}" required placeholder="Kelurahan">
                                        <div class="invalid-feedback">
                                            Data wajib diisi.
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="{{old('kecamatan')}}" required placeholder="Kecamatan">
                                        <div class="invalid-feedback">
                                            Data wajib diisi.
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="kodepos" name="kodepos" min="0" value="{{old('kodepos')}}" required placeholder="Kodepos">
                                        <div class="invalid-feedback">
                                            Data wajib diisi.
                                        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-6">
                                    <a href="{{ route('kodepos') }}" class="btn btn-secondary waves-effect">Cancel</a>
                                </div>
                                <div class="col-sm-6">
