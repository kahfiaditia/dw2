                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    @if ($type === 'reverify')
                                        <form class="needs-validation" action="{{ route("login.reverifycode") }}" method="POST" novalidate>
                                    @else
                                        <form class="needs-validation" action="{{ route("login.resetcode") }}" method="POST" novalidate>
                                    @endif
                                        @csrf
