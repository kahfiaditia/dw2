...
@section('container')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('needs.update', \Crypt::encryptString($needs->id)) }}"
                method="POST" novalidate>
                @csrf
                @method('PATCH')
                <input type="hidden" class="Id" id="Id" name="id" value="{{ $needs->id }}">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kode" name="kode"
                                                value="{{ $needs->kode }}" required placeholder="Kode" autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ $needs->nama }}" required placeholder="Kebutuhan Khusus"
                                                autofocus>
                                            <div class="invalid-feedback">
                                                Data wajib diisi.
                                            </div>
