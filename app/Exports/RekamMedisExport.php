...
class RekamMedisExport implements WithColumnFormatting, FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    {
        $cellRange      = 'A1:I' . count($this->list->get()) + 1;
        $cellHeader      = 'A1:I1';
        return [
            AfterSheet::class    => function (AfterSheet $event) use ($cellRange, $cellHeader) {
