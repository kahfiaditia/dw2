...
class UserPenerbit extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('perpus_penerbit', function (Blueprint $table) {
            $table->unsignedBigInteger('user_created')->nullable()->after('nama_penerbit');
