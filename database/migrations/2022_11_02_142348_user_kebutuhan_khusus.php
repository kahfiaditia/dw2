...
class UserKebutuhanKhusus extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('kebutuhan_khusus', function (Blueprint $table) {
            $table->unsignedBigInteger('user_created')->nullable()->after('nama');
