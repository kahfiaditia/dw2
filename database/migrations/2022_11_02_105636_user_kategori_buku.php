...
class UserKategoriBuku extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('perpus_kategori_buku', function (Blueprint $table) {
            $table->unsignedBigInteger('user_created')->nullable()->after('kategori');
